...
const DashboardCard = ({ user, onEdit, onDelete }) => {
	return (
		<div className="relative rounded-[40px] w-[236px] h-[320px] lg:w-[300px] lg:h-[400px] overflow-hidden">
			<div className="w-full h-full">
				<img
					src="https://images.unsplash.com/photo-1514315384763-ba401779410f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=983&q=80"
			...
			<div className="absolute rounded-[40px] bottom-0 flex flex-col justify-end w-full p-8 text-white bg-gradient-to-t from-primary-100 to-transparent h-2/5">
				<h3 className="text-2xl font-semibold lg:text-3xl">username</h3>
			</div>

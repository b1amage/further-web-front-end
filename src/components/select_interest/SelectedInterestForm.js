...
export const SelectedInterestForm = ({
	...
	return (
		<form onSubmit={onSubmit} className="h-full">
			...
			<div className="inline-flex flex-wrap w-full gap-4 px-6 py-5 my-10 mt-8 overflow-y-scroll border-t md:h-1/5 h-2/5 md:my-0 md:mt-4 border-t-gray dark:border-t-dark-3">
				<SelectedList
					array={selectedList}
			...
			<div className="pt-2 pb-[40px] px-6 h-fit w-full inline-flex items-center border-t border-t-gray dark:border-t-dark-3 rounded-t-[24px]">
				<Button
					name={"Next"}

...
export const IdeaType = ({id, icon, type, onChangeType, iconClassName, className}) => {
  return (
    <div>
      ...
      <label htmlFor={id} className={`flex flex-col justify-center items-center text-left bg-white rounded-[20px] border border-gray peer-checked:border-primary-100 ${className} w-[150px] h-[150px] sm:w-[200px] sm:h-[200px] md:w-[280px] md:h-[280px] lg:w-[300px] lg:h-[300px] lg:mx-[80px] md:mx-[10px] mx-[5px]`}>

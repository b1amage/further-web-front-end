...
export const InputBox = ({id, name, title, value ,handleOnChange}) => {
  ...
  return (
    <div className="my-6">
      ...
      <div className={`w-full h-12 flex rounded-[100px] ${value.length > 0 ? "outline-primary-100" : "outline-gray"} outline px-6 py-3 mt-2`}>
        <input
        ...
        />
        <img src={hiddenPasswordButton} alt="hidden-button" onClick={showPassword}/>
      </div>
    </div>
  );
};

...
export const ResetPassword = () => {
        ...
        if (!passwordRegex.test(newPwd)){
          ...
          if (newPwd !== confirmPwd){
            setError("* Invalid password")
              ...
              resetPasswordApi.resetPassword(newPwd, JSON.parse(localStorage.getItem("resetToken")),navigate).then(res => {
              localStorage.setItem("message", JSON.stringify(res.data.msg))
  ...
  return (
    <div className='mx-6 mt-7 sm:mx-[100px] md:mx-[200px] lg:mx-[350px]'>
        ...
        <ResetPasswordForm validatePassword={validatePassword} newPwd={newPwd} onChangeNewPassword={onChangeNewPassword} confirmPwd={confirmPwd} onChangeConfirmPassword={onChangeConfirmPassword} error={error} />
    </div>
  )
}
